...
## 🔄 ৮. কন্টিনিউয়াস হিস্ট্রি ও ব্যাকআপ নিয়মাবলী

1. যেকোনো নতুন কাজ শুরু করার আগে যেকোনো এআই বা ডেভেলপার এই `PROJECT_HISTORY.md` ফাইলটি পড়বে।
2. নতুন ফিচার বা পরিবর্তন যোগ করার পর এই ফাইলটিতে হিস্ট্রি আপডেট করবে।
3. নিয়মিত গিটহাবে (`git push`) এবং গুগল ড্রাইভে প্রজেক্ট ব্যাকআপ রাখা হবে।
